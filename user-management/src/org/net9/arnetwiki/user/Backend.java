package org.net9.arnetwiki.user;

import org.net9.arnetwiki.user.exception.BackendConnectionException;
import org.net9.arnetwiki.user.exception.ForbiddenException;
import org.net9.arnetwiki.user.exception.GenericException;
import org.net9.arnetwiki.user.exception.LoginFailedException;
import org.net9.arnetwiki.user.exception.NotFoundException;
import org.net9.arnetwiki.user.util.CredentialEncoder;
import org.net9.arnetwiki.user.xml.GenericBean;
import org.net9.arnetwiki.user.xml.PersonBean;
import org.net9.arnetwiki.user.xml.UpdateBean;
